...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=5000)                                           BOT_UID = int('16220192899') # <- FIXED BOT UID.      
    Uid , Pw = '5383477682','0CDFEFB6098408FEE9E2164B0FE5725EE60CF8764660245DEBD7A1C0A2B9F657'